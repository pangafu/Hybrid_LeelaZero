...
def gen_children(all_parent_weight, parameter, randominherit):
    ...
    if len(hbparam) == 8:
        des_parent_weights = itertools.product(all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight)

    if len(hbparam) == 9:
        des_parent_weights = itertools.product(all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight, all_parent_weight)
